...
@section('title', 'Centro de mando academico')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            <h4 class="mb-1">Centro de mando academico</h4>
                            <p class="text-muted mb-0">
                                Riesgo estudiantil, seguimiento docente y operacion diaria en un solo tablero.
                            </p>
                        </div>
