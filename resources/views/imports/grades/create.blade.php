...
@section('title', 'Importar evaluacion')
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Importar actividades y calificaciones</h3>
                </div>

                <form method="POST"
                      action="{{ route('imports.grades.store') }}"
                      enctype="multipart/form-data">
                    @csrf

                    <div class="card-body">
                        <div class="alert alert-info mb-3">
                            <strong>Formato esperado:</strong> hojas con nombre
                            <code>GRUPO-MATERIA</code> y actividades en la fila 2.
                            Se importan actividades y calificaciones por alumno.
                            La calificacion final se recalcula dentro del sistema.
                        </div>
