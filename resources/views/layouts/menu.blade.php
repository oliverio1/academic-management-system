...
<li class="nav-item">
    <a href="{{ route('coordination.students.academic-summary') }}"
       class="nav-link {{ $isActive(['coordination.students.academic-summary', 'coordination.students.subject-detail', 'coordination.students.prefect-attendance-detail']) }}">
...
<li class="nav-item">
    <a href="{{ route('coordination.teacher-performance.index') }}"
       class="nav-link {{ $isActive('coordination.teacher-performance.*') }}">
...
<li class="nav-item">
    <a href="{{ route('coordination.school-cases.index') }}"
       class="nav-link {{ $isActive('coordination.school-cases.*') }}">
        <i class="nav-icon fas fa-folder-open"></i>
        <p>Casos escolares</p>
    </a>
</li>
...
<li class="nav-item {{ $isOpen(['school-cycles.*', 'imports.master-schedule.*', 'imports.cycle-students.*', 'coordination.cycle-planning.*', 'coordination.cycle-subjects.*', 'academic-calendar-days.*']) }}">
    <a href="#"
       class="nav-link {{ $isActive(['school-cycles.*', 'imports.master-schedule.*', 'imports.cycle-students.*', 'coordination.cycle-planning.*', 'coordination.cycle-subjects.*', 'academic-calendar-days.*']) }}">
        ...
        <li class="nav-item">
            <a href="{{ route('coordination.cycle-planning.index') }}"
               class="nav-link {{ $isActive('coordination.cycle-planning.*') }}">
                <i class="far fa-circle nav-icon"></i>
                <p>Grupos y materias del ciclo</p>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('coordination.cycle-subjects.index') }}"
               class="nav-link {{ $isActive('coordination.cycle-subjects.*') }}">
                <i class="far fa-circle nav-icon"></i>
                <p>Materias y temarios</p>
            </a>
        </li>
        <li class="nav-item">
...
<li class="nav-item">
    <a href="{{ route('prefect.class-skips.index') }}"
       class="nav-link {{ $isActive('prefect.class-skips.*') }}">
        <i class="nav-icon fas fa-running"></i>
        <p>Alumnos fuera de clase</p>
    </a>
</li>
...
<li class="nav-item">
    <a href="{{ route('student.grades') }}"
       class="nav-link {{ $isActive('student.grades') }}">
        <i class="nav-icon fas fa-chart-line"></i>
        <p>Desempeño académico</p>
    </a>
</li>
