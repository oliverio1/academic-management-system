...
@section('title', 'Mis reportes de situaciones')
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="mb-0">Mis reportes de situaciones</h3>
                <a href="{{ route('student.incident-reports.create') }}" class="btn btn-primary">
